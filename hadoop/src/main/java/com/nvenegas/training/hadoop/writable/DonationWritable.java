package com.nvenegas.training.hadoop.writable;
...
import com.nvenegas.training.hadoop.tools.StringHelper;
...
public class DonationWritable implements WritableComparable<DonationWritable> {
	...
	public String toString() {
		return String.format("%s|project=%s|city=%s|total=%.2f", donation_id, project_id, donor_city, total);
	}
}
